...
include 'header.php' ?>
            ...
            <div class="col-xl-6">
              <div class="about-two__left">
                <div
                  ...
                  style="
                    background-image: url(assets/images/resources/IMA5.jpg);
                  "
                ></div>
              </div>
            </div>
              ...
              <div class="about-two__right">
                <div class="section-title text-left">
                  <!-- <div class="section-title__tagline-box">
                    <p
                      class="section-title__tagline section-title__tagline--two"
                    >
                      <span>//</span> About Company
                    </p>
                  </div> -->
                  <h2 class="section-title__title">
                    About <span>BrandMagic</span>
                  </h2>
                </div>
                <p class="about-two__text style-uniform">
                With a dedicated team of professionals, we create ideas and the innovations with a justified value. We understand the market & clients product value thus creating more effective solutions for the product to reach the customer & generate interest. Our Mission is to ensure these events generate a positive impact and motivate our client’s audience. We do this by thinking strategically and imaginatively about how to best meet our client’s business objectives.
                ...
                <!-- <div class="about-two__solution-box">
                  <div class="about-two__solution-single">
                    ...
                    <p class="about-two__solition-text">
                      Solution for small & <br />
                      large businesses
                    </p>
                  </div>
                  <div class="about-two__solution-single">
                ...
                <ul class="about-two__points list-unstyled">
                  <li>
                    ...
                    <p>We manage events gratifying the diverse needs for corporate as 
                      well as for individual client’s -ranging from launching a product
                       to celebrating an anniversary to announcing awards or
                       conducting awareness campaigns.</p>
                  </li>
                  <li>
                    <div class="icon">
                      <span class="icon-check-1"></span>
                    </div>
                    <p> We offer clients imaginative ideas which will craft 
                      their events to stand a part. Our original ideas
                       blossom into reality with the superb production.
                    </p>
                  </li>
                </ul>
                <!-- <div class="about-two__btn-and-client-info">
                  <div class="about-two__btn-box">
                    <a href="about" class="about-two__btn thm-btn-two"
                      ><span class="fas fa-arrow-circle-right"></span>Discover
                      more</a
                    >
                  </div>
      ...
      <!-- <section class="countdown-one">
        <div
          class="countdown-one__bg"
          style="
            background-image: url(assets/images/backgrounds/countdown-one-bg.jpg);
          "
        ></div>
        ...
        <div class="container">
          <div class="countdown-one__top">
            ...
            <div class="countdown-one__btn-box">
              <a href="contact" class="countdown-one__btn thm-btn-two"
                ><span class="fas fa-arrow-circle-right"></span>Book Your
                Seat</a
              >
            </div>
          </div>
          <div class="countdown-one__inner">
            <div class="countdown-one__shape-1">
              <img
                src="assets/images/shapes/countdown-one-shape-1.png"
                alt=""
              />
            </div>
            <div
              class="countdown time-countdown-one"
              data-countdown-time="2024/07/23"
            ></div>
          </div>
        </div>
      </section> -->
      ...
      <!-- <section class="team-two">
        <div
          class="team-two__bg"
          style="
            background-image: url(assets/images/backgrounds/team-two-bg.jpg);
          "
        ></div>
        <div class="container">
          <div class="team-two__top">
            ...
            <p class="team-two__text">
              Whether designing a cozy apartment for a young couple or<br />
            ...
            >
              <div class="team-two__single">
                ...
                <div class="team-two__social">
                  ...
                  <a href="#" class="team-two__social-two"
                    ><span class="fab fa-facebook-f"></span
                  ></a>
                  <a href="#" class="team-two__social-three"
                ...
                <div class="team-two__content">
                  ...
                  <h3 class="team-two__title">
                    <a href="speaker-single.html">James Smith</a>
                  </h3> -->
                  <!-- <p class="team-two__single-text">
                    This includes websites <br />
                    digital platforms.
                  </p> -->
                <!-- </div>
              </div>
            ...
            >
              <div class="team-two__single">
                ...
                <div class="team-two__content">
                  <p class="team-two__sub-title">Ceo Founder</p>
                  <h3 class="team-two__title">
                    <a href="speaker-single.html">Robert Smith</a>
                  </h3> -->
                  <!-- <p class="team-two__single-text">
                    This includes websites <br />
                    digital platforms.
            ...
            >
              <div class="team-two__single">
                ...
                <div class="team-two__content">
                  <p class="team-two__sub-title">Ceo Founder</p>
                  <h3 class="team-two__title">
                    <a href="speaker-single.html">Michael Smith</a>
                  </h3>
                  <p class="team-two__single-text">
                    This includes websites <br />
                    digital platforms.
            ...
            >
              <div class="team-two__single">
                ...
                <div class="team-two__content">
                  <p class="team-two__sub-title">Ceo Founder</p>
                  <h3 class="team-two__title">
                    <a href="speaker-single.html">William Smith</a>
                  </h3>
                  <p class="team-two__single-text">
                    This includes websites <br />
                    digital platforms.
